#!/bin/bash
  ...
  # Auto-redirect: root URL seedha desktop
  echo '<html><head><meta http-equiv="refresh" content="0; url=vnc_auto.html"></head><body>Redirecting...</body></html>' > /usr/share/novnc/index.html
